...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ThreadComment> comments});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<ThreadComment> comments})
      : _comments = comments;

  final List<ThreadComment> _comments;
  @override
  List<ThreadComment> get comments {
