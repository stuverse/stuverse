...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Thread> threads) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Thread> threads)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<Thread> threads})
      : _threads = threads;
  ...
  @override
  String toString() {
    return 'HomeState.loaded(threads: $threads)';
  }
...
abstract class _Loaded implements HomeState {
  const factory _Loaded({required final List<Thread> threads}) = _$LoadedImpl;
