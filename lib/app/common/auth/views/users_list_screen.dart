                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        if(user.linkedin != null && (user.linkedin?.isNotEmpty ?? false) )
                        InkWell(
                          onTap: () {
                         context.push(CommonRoutes.webView, extra: user.linkedin);
                          },
                          child: CircleAvatar(
                        ...
                        100.widthBox,
                        if(user.github != null && (user.github?.isNotEmpty ?? false) )
                        InkWell(
                          onTap: () {
                       context.push(CommonRoutes.webView, extra: user.github);
                          },
                          child: CircleAvatar(
                            backgroundColor: Colors.white,
                            radius: context.height * 0.02,
                  ...
                  Padding(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          if(user.mobile != null && (user.mobile?.isNotEmpty ?? false) )
                          Row(
                            children: [
                              Icon(
                                Icons.phone,
                    ...
                    child: Row(
                     ...
                     children: [
                       InkWell(
                        onTap:()async{
                            final url =
                          Uri.parse("http://wa.me/+91${user.mobile ?? ""}");
                      ...
                      if (!canlaunch) {
                       ...
                       Expanded(
                         ...
                         child: InkWell(
                          onTap: () {
                            context.push(CommonRoutes.pdfViewer, extra: user.resume);
                          },
                           child: Container(
                             decoration: BoxDecoration(
                                 borderRadius: BorderRadius.circular(10),
