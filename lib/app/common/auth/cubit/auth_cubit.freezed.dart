...
class __$$SignInLoadingImplCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res, _$SignInLoadingImpl>
...
abstract class _SignInLoading implements AuthState {
...
class _$SignInFailureImpl implements _SignInFailure {
  const _$SignInFailureImpl(this.message);
  ...
  @override
  String toString() {
    return 'AuthState.signInFailure(message: $message)';
  }
...
abstract class _SignInFailure implements AuthState {
  const factory _SignInFailure(final String message) = _$SignInFailureImpl;
...
abstract class _SignUpLoading implements AuthState {
...
class __$$AccountNotVerifiedImplCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res, _$AccountNotVerifiedImpl>
...
class _$AccountNotVerifiedImpl implements _AccountNotVerified {
  const _$AccountNotVerifiedImpl();

  @override
  String toString() {
    return 'AuthState.accountNotVerified()';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$AccountNotVerifiedImpl);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return accountNotVerified?.call();
  }
...
abstract class _AccountNotVerified implements AuthState {
  const factory _AccountNotVerified() = _$AccountNotVerifiedImpl;
}
